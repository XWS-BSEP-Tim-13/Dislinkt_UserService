...
var file_user_service_proto_rawDesc = []byte{
	...
	0x05, 0x73, 0x6b, 0x69, 0x6c, 0x6c, 0x32, 0x9c, 0x08, 0x0a, 0x0b, 0x55, 0x73, 0x65, 0x72, 0x53,
	...
	0x74, 0x3a, 0x0a, 0x63, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x64, 0x0a,
	...
	0x64, 0x61, 0x74, 0x65, 0x12, 0x5f, 0x0a, 0x08, 0x41, 0x64, 0x64, 0x53, 0x6b, 0x69, 0x6c, 0x6c,
	...
	0x73, 0x6b, 0x69, 0x6c, 0x6c, 0x42, 0x4b, 0x5a, 0x49, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e,
...
var file_user_service_proto_depIdxs = []int32{
	...
	27, // 6: user.User.dateOfBirth:type_name -> google.protobuf.Timestamp
	...
	27, // 10: user.Experience.startDate:type_name -> google.protobuf.Timestamp
	27, // 11: user.Experience.endDate:type_name -> google.protobuf.Timestamp
	2,  // 12: user.Education.degree:type_name -> user.Education.Degree
	27, // 13: user.Education.startDate:type_name -> google.protobuf.Timestamp
	27, // 14: user.Education.endDate:type_name -> google.protobuf.Timestamp
	14, // 15: user.ConnectionRequest.from:type_name -> user.User
	14, // 16: user.ConnectionRequest.to:type_name -> user.User
	27, // 17: user.ConnectionRequest.requestTime:type_name -> google.protobuf.Timestamp
	27, // 18: user.UserInfo.dateOfBirth:type_name -> google.protobuf.Timestamp
	...
	9,  // 26: user.UserService.Get:input_type -> user.GetRequest
	11, // 27: user.UserService.GetAll:input_type -> user.GetAllRequest
	13, // 28: user.UserService.CreateUser:input_type -> user.NewUser
	8,  // 29: user.UserService.FindByFilter:input_type -> user.UserFilter
	5,  // 30: user.UserService.RequestConnection:input_type -> user.ConnectionBody
	9,  // 31: user.UserService.GetRequestsForUser:input_type -> user.GetRequest
	9,  // 32: user.UserService.AcceptConnectionRequest:input_type -> user.GetRequest
	19, // 33: user.UserService.UpdatePersonalInfo:input_type -> user.UserInfoUpdate
	22, // 34: user.UserService.AddExperience:input_type -> user.ExperienceUpdateRequest
	24, // 35: user.UserService.AddEducation:input_type -> user.EducationUpdateRequest
	26, // 36: user.UserService.AddSkill:input_type -> user.SkillsUpdateRequest
	10, // 37: user.UserService.Get:output_type -> user.GetResponse
	12, // 38: user.UserService.GetAll:output_type -> user.GetAllResponse
	13, // 39: user.UserService.CreateUser:output_type -> user.NewUser
	12, // 40: user.UserService.FindByFilter:output_type -> user.GetAllResponse
	4,  // 41: user.UserService.RequestConnection:output_type -> user.ConnectionResponse
	6,  // 42: user.UserService.GetRequestsForUser:output_type -> user.UserRequests
	4,  // 43: user.UserService.AcceptConnectionRequest:output_type -> user.ConnectionResponse
	20, // 44: user.UserService.UpdatePersonalInfo:output_type -> user.UserInfoUpdateResponse
	20, // 45: user.UserService.AddExperience:output_type -> user.UserInfoUpdateResponse
	20, // 46: user.UserService.AddEducation:output_type -> user.UserInfoUpdateResponse
	20, // 47: user.UserService.AddSkill:output_type -> user.UserInfoUpdateResponse
