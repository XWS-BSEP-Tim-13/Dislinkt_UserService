...
var file_user_service_proto_rawDesc = []byte{
	...
	0xcb, 0x06, 0x0a, 0x0b, 0x55, 0x73, 0x65, 0x72, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12,
	...
	0x62, 0x79, 0x2d, 0x75, 0x73, 0x65, 0x72, 0x2f, 0x7b, 0x69, 0x64, 0x7d, 0x12, 0x6f, 0x0a, 0x12,
...
var file_user_service_proto_depIdxs = []int32{
	...
	19, // 31: user.UserService.UpdatePersonalInfo:input_type -> user.UserInfoUpdate
	22, // 32: user.UserService.AddExperience:input_type -> user.ExperienceUpdateRequest
	24, // 33: user.UserService.AddEducation:input_type -> user.EducationUpdateRequest
	10, // 34: user.UserService.Get:output_type -> user.GetResponse
	12, // 35: user.UserService.GetAll:output_type -> user.GetAllResponse
	13, // 36: user.UserService.CreateUser:output_type -> user.NewUser
	12, // 37: user.UserService.FindByFilter:output_type -> user.GetAllResponse
	4,  // 38: user.UserService.RequestConnection:output_type -> user.ConnectionResponse
	6,  // 39: user.UserService.GetRequestsForUser:output_type -> user.UserRequests
	20, // 40: user.UserService.UpdatePersonalInfo:output_type -> user.UserInfoUpdateResponse
	20, // 41: user.UserService.AddExperience:output_type -> user.UserInfoUpdateResponse
	20, // 42: user.UserService.AddEducation:output_type -> user.UserInfoUpdateResponse
