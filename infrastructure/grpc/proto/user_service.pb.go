...
var file_user_service_proto_rawDesc = []byte{
	...
	0x32, 0xac, 0x04, 0x0a, 0x0b, 0x55, 0x73, 0x65, 0x72, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65,
	...
	0x65, 0x73, 0x74, 0x2f, 0x61, 0x63, 0x63, 0x65, 0x70, 0x74, 0x2f, 0x7b, 0x69, 0x64, 0x7d, 0x42,
...
var file_user_service_proto_depIdxs = []int32{
	...
	8,  // 22: user.UserService.AcceptConnectionRequest:input_type -> user.GetRequest
	9,  // 23: user.UserService.Get:output_type -> user.GetResponse
	11, // 24: user.UserService.GetAll:output_type -> user.GetAllResponse
	11, // 25: user.UserService.FindByFilter:output_type -> user.GetAllResponse
	3,  // 26: user.UserService.RequestConnection:output_type -> user.ConnectionResponse
	5,  // 27: user.UserService.GetRequestsForUser:output_type -> user.UserRequests
	3,  // 28: user.UserService.AcceptConnectionRequest:output_type -> user.ConnectionResponse
