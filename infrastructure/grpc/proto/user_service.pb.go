...
var file_user_service_proto_rawDesc = []byte{
	...
	0x69, 0x6f, 0x6e, 0x22, 0x38, 0x0a, 0x0a, 0x43, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x69, 0x6f,
	0x6e, 0x12, 0x16, 0x0a, 0x06, 0x69, 0x64, 0x46, 0x72, 0x6f, 0x6d, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x06, 0x69, 0x64, 0x46, 0x72, 0x6f, 0x6d, 0x12, 0x12, 0x0a, 0x04, 0x69, 0x64, 0x54,
	0x6f, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x69, 0x64, 0x54, 0x6f, 0x22, 0x24, 0x0a,
	0x0a, 0x55, 0x73, 0x65, 0x72, 0x46, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x12, 0x16, 0x0a, 0x06, 0x66,
	0x69, 0x6c, 0x74, 0x65, 0x72, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x66, 0x69, 0x6c,
	0x74, 0x65, 0x72, 0x22, 0x1c, 0x0a, 0x0a, 0x47, 0x65, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
	...
	0x75, 0x73, 0x65, 0x72, 0x73, 0x22, 0x8a, 0x04, 0x0a, 0x04, 0x55, 0x73, 0x65, 0x72, 0x12, 0x0e,
	...
	0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x54, 0x69, 0x6d, 0x65, 0x32, 0xd6, 0x02, 0x0a, 0x0b,
	...
	0x74, 0x69, 0x6f, 0x6e, 0x42, 0x4b, 0x5a, 0x49, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63,
	0x6f, 0x6d, 0x2f, 0x58, 0x57, 0x53, 0x2d, 0x42, 0x53, 0x45, 0x50, 0x2d, 0x54, 0x69, 0x6d, 0x2d,
	0x31, 0x33, 0x2f, 0x44, 0x69, 0x73, 0x6c, 0x69, 0x6e, 0x6b, 0x74, 0x5f, 0x55, 0x73, 0x65, 0x72,
...
var file_user_service_proto_goTypes = []interface{}{
	...
	(*Connection)(nil),             // 5: user.Connection
	(*UserFilter)(nil),             // 6: user.UserFilter
	...
	(*Experience)(nil),             // 12: user.Experience
	(*Education)(nil),              // 13: user.Education
	(*ConnectionRequest)(nil),      // 14: user.ConnectionRequest
	(*timestamppb.Timestamp)(nil),  // 15: google.protobuf.Timestamp
}
var file_user_service_proto_depIdxs = []int32{
	5,  // 0: user.ConnectionBody.connection:type_name -> user.Connection
	11, // 1: user.GetResponse.user:type_name -> user.User
	11, // 2: user.GetAllResponse.users:type_name -> user.User
	0,  // 3: user.User.gender:type_name -> user.User.Gender
	15, // 4: user.User.dateOfBirth:type_name -> google.protobuf.Timestamp
	12, // 5: user.User.experiences:type_name -> user.Experience
	13, // 6: user.User.educations:type_name -> user.Education
	1,  // 7: user.Experience.employmentType:type_name -> user.Experience.EmploymentType
	15, // 8: user.Experience.startDate:type_name -> google.protobuf.Timestamp
	15, // 9: user.Experience.endDate:type_name -> google.protobuf.Timestamp
	2,  // 10: user.Education.degree:type_name -> user.Education.Degree
	15, // 11: user.Education.startDate:type_name -> google.protobuf.Timestamp
	15, // 12: user.Education.endDate:type_name -> google.protobuf.Timestamp
	11, // 13: user.ConnectionRequest.from:type_name -> user.User
	11, // 14: user.ConnectionRequest.to:type_name -> user.User
	15, // 15: user.ConnectionRequest.requestTime:type_name -> google.protobuf.Timestamp
	7,  // 16: user.UserService.Get:input_type -> user.GetRequest
	9,  // 17: user.UserService.GetAll:input_type -> user.GetAllRequest
	6,  // 18: user.UserService.FindByFilter:input_type -> user.UserFilter
	4,  // 19: user.UserService.RequestConnection:input_type -> user.ConnectionBody
	8,  // 20: user.UserService.Get:output_type -> user.GetResponse
	10, // 21: user.UserService.GetAll:output_type -> user.GetAllResponse
	10, // 22: user.UserService.FindByFilter:output_type -> user.GetAllResponse
	3,  // 23: user.UserService.RequestConnection:output_type -> user.ConnectionResponse
