...
var file_user_service_proto_rawDesc = []byte{
	...
	0x69, 0x64, 0x32, 0xad, 0x04, 0x0a, 0x0b, 0x55, 0x73, 0x65, 0x72, 0x53, 0x65, 0x72, 0x76, 0x69,
	...
	0x64, 0x7d, 0x12, 0x42, 0x0a, 0x06, 0x47, 0x65, 0x74, 0x41, 0x6c, 0x6c, 0x12, 0x13, 0x2e, 0x75,
	...
	0x05, 0x2f, 0x75, 0x73, 0x65, 0x72, 0x12, 0x55, 0x0a, 0x0c, 0x46, 0x69, 0x6e, 0x64, 0x42, 0x79,
...
var file_user_service_proto_depIdxs = []int32{
	...
	20, // 5: user.User.dateOfBirth:type_name -> google.protobuf.Timestamp
	...
	20, // 9: user.Experience.startDate:type_name -> google.protobuf.Timestamp
	20, // 10: user.Experience.endDate:type_name -> google.protobuf.Timestamp
	2,  // 11: user.Education.degree:type_name -> user.Education.Degree
	20, // 12: user.Education.startDate:type_name -> google.protobuf.Timestamp
	20, // 13: user.Education.endDate:type_name -> google.protobuf.Timestamp
	13, // 14: user.ConnectionRequest.from:type_name -> user.User
	13, // 15: user.ConnectionRequest.to:type_name -> user.User
	20, // 16: user.ConnectionRequest.requestTime:type_name -> google.protobuf.Timestamp
	20, // 17: user.UserInfo.dateOfBirth:type_name -> google.protobuf.Timestamp
	3,  // 18: user.UserInfo.gender:type_name -> user.UserInfo.Gender
	17, // 19: user.UserInfoUpdate.userInfo:type_name -> user.UserInfo
	9,  // 20: user.UserService.Get:input_type -> user.GetRequest
	11, // 21: user.UserService.GetAll:input_type -> user.GetAllRequest
	8,  // 22: user.UserService.FindByFilter:input_type -> user.UserFilter
	5,  // 23: user.UserService.RequestConnection:input_type -> user.ConnectionBody
	9,  // 24: user.UserService.GetRequestsForUser:input_type -> user.GetRequest
	18, // 25: user.UserService.UpdatePersonalInfo:input_type -> user.UserInfoUpdate
	10, // 26: user.UserService.Get:output_type -> user.GetResponse
	12, // 27: user.UserService.GetAll:output_type -> user.GetAllResponse
	12, // 28: user.UserService.FindByFilter:output_type -> user.GetAllResponse
	4,  // 29: user.UserService.RequestConnection:output_type -> user.ConnectionResponse
	6,  // 30: user.UserService.GetRequestsForUser:output_type -> user.UserRequests
	19, // 31: user.UserService.UpdatePersonalInfo:output_type -> user.UserInfoUpdateResponse
