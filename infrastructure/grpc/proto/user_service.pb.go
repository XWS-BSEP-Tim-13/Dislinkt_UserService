...
var file_user_service_proto_rawDesc = []byte{
	...
	0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x54, 0x69, 0x6d, 0x65, 0x32, 0xea, 0x03, 0x0a, 0x0b,
	0x55, 0x73, 0x65, 0x72, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x3e, 0x0a, 0x03, 0x47,
	...
	0x0a, 0x2f, 0x75, 0x73, 0x65, 0x72, 0x2f, 0x7b, 0x69, 0x64, 0x7d, 0x12, 0x42, 0x0a, 0x06, 0x47,
	0x65, 0x74, 0x41, 0x6c, 0x6c, 0x12, 0x13, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x47, 0x65, 0x74,
	0x41, 0x6c, 0x6c, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x14, 0x2e, 0x75, 0x73, 0x65,
	...
	0x2c, 0x0a, 0x0a, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x55, 0x73, 0x65, 0x72, 0x12, 0x0d, 0x2e,
	0x75, 0x73, 0x65, 0x72, 0x2e, 0x4e, 0x65, 0x77, 0x55, 0x73, 0x65, 0x72, 0x1a, 0x0d, 0x2e, 0x75,
	0x73, 0x65, 0x72, 0x2e, 0x4e, 0x65, 0x77, 0x55, 0x73, 0x65, 0x72, 0x22, 0x00, 0x12, 0x55, 0x0a,
	...
	0x73, 0x65, 0x72, 0x2f, 0x7b, 0x69, 0x64, 0x7d, 0x42, 0x4b, 0x5a, 0x49, 0x67, 0x69, 0x74, 0x68,
...
var file_user_service_proto_depIdxs = []int32{
	...
	13, // 4: user.NewUser.user:type_name -> user.User
	0,  // 5: user.User.gender:type_name -> user.User.Gender
	17, // 6: user.User.dateOfBirth:type_name -> google.protobuf.Timestamp
	14, // 7: user.User.experiences:type_name -> user.Experience
	15, // 8: user.User.educations:type_name -> user.Education
	1,  // 9: user.Experience.employmentType:type_name -> user.Experience.EmploymentType
	17, // 10: user.Experience.startDate:type_name -> google.protobuf.Timestamp
	17, // 11: user.Experience.endDate:type_name -> google.protobuf.Timestamp
	2,  // 12: user.Education.degree:type_name -> user.Education.Degree
	17, // 13: user.Education.startDate:type_name -> google.protobuf.Timestamp
	17, // 14: user.Education.endDate:type_name -> google.protobuf.Timestamp
	13, // 15: user.ConnectionRequest.from:type_name -> user.User
	13, // 16: user.ConnectionRequest.to:type_name -> user.User
	17, // 17: user.ConnectionRequest.requestTime:type_name -> google.protobuf.Timestamp
	8,  // 18: user.UserService.Get:input_type -> user.GetRequest
	10, // 19: user.UserService.GetAll:input_type -> user.GetAllRequest
	12, // 20: user.UserService.CreateUser:input_type -> user.NewUser
	7,  // 21: user.UserService.FindByFilter:input_type -> user.UserFilter
	4,  // 22: user.UserService.RequestConnection:input_type -> user.ConnectionBody
	8,  // 23: user.UserService.GetRequestsForUser:input_type -> user.GetRequest
	9,  // 24: user.UserService.Get:output_type -> user.GetResponse
	11, // 25: user.UserService.GetAll:output_type -> user.GetAllResponse
	12, // 26: user.UserService.CreateUser:output_type -> user.NewUser
	11, // 27: user.UserService.FindByFilter:output_type -> user.GetAllResponse
	3,  // 28: user.UserService.RequestConnection:output_type -> user.ConnectionResponse
	5,  // 29: user.UserService.GetRequestsForUser:output_type -> user.UserRequests
