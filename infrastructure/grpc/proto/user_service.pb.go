...
func (x *SkillsUpdateRequest) GetSkill() string {
	if x != nil {
		return x.Skill
	}
	return ""
...
func (x *SkillsUpdateRequest) GetUserId() string {
	if x != nil {
		return x.UserId
	}
	return ""
...
var file_user_service_proto_rawDesc = []byte{
	...
	0x43, 0x0a, 0x13, 0x53, 0x6b, 0x69, 0x6c, 0x6c, 0x73, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x52,
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x14, 0x0a, 0x05, 0x73, 0x6b, 0x69, 0x6c, 0x6c, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x73, 0x6b, 0x69, 0x6c, 0x6c, 0x12, 0x16, 0x0a, 0x06,
	0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x75, 0x73,
	0x65, 0x72, 0x49, 0x64, 0x32, 0x9c, 0x08, 0x0a, 0x0b, 0x55, 0x73, 0x65, 0x72, 0x53, 0x65, 0x72,
	...
	0x69, 0x6c, 0x6c, 0x42, 0x4b, 0x5a, 0x49, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f,
...
var file_user_service_proto_goTypes = []interface{}{
	...
	(*SkillsUpdateRequest)(nil),     // 25: user.SkillsUpdateRequest
...
var file_user_service_proto_depIdxs = []int32{
	...
	9,  // 25: user.UserService.Get:input_type -> user.GetRequest
	11, // 26: user.UserService.GetAll:input_type -> user.GetAllRequest
	13, // 27: user.UserService.CreateUser:input_type -> user.NewUser
	8,  // 28: user.UserService.FindByFilter:input_type -> user.UserFilter
	5,  // 29: user.UserService.RequestConnection:input_type -> user.ConnectionBody
	9,  // 30: user.UserService.GetRequestsForUser:input_type -> user.GetRequest
	9,  // 31: user.UserService.AcceptConnectionRequest:input_type -> user.GetRequest
	19, // 32: user.UserService.UpdatePersonalInfo:input_type -> user.UserInfoUpdate
	22, // 33: user.UserService.AddExperience:input_type -> user.ExperienceUpdateRequest
	24, // 34: user.UserService.AddEducation:input_type -> user.EducationUpdateRequest
	25, // 35: user.UserService.AddSkill:input_type -> user.SkillsUpdateRequest
	10, // 36: user.UserService.Get:output_type -> user.GetResponse
	12, // 37: user.UserService.GetAll:output_type -> user.GetAllResponse
	13, // 38: user.UserService.CreateUser:output_type -> user.NewUser
	12, // 39: user.UserService.FindByFilter:output_type -> user.GetAllResponse
	4,  // 40: user.UserService.RequestConnection:output_type -> user.ConnectionResponse
	6,  // 41: user.UserService.GetRequestsForUser:output_type -> user.UserRequests
	4,  // 42: user.UserService.AcceptConnectionRequest:output_type -> user.ConnectionResponse
	20, // 43: user.UserService.UpdatePersonalInfo:output_type -> user.UserInfoUpdateResponse
	20, // 44: user.UserService.AddExperience:output_type -> user.UserInfoUpdateResponse
	20, // 45: user.UserService.AddEducation:output_type -> user.UserInfoUpdateResponse
	20, // 46: user.UserService.AddSkill:output_type -> user.UserInfoUpdateResponse
